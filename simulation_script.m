...
outputfile = '~/Documents/mutBiasCI/data/TimeSeries/mutBiasCI_data_for_2d_distribution_ml-200'; 
...
dlmwrite('~/Documents/mutBiasCI/data/TwoTraitSim/mutBiasCI_data_all_simulation_parameters_ml-200-0.dat',NsU,'delimiter',',','precision',16);
dlmwrite('~/Documents/mutBiasCI/data/TwoTraitSim/mutBiasCI_data_all_simulation_grand_means_ml-200-1.dat',sim_data,'delimiter',',','precision',16);
dlmwrite('~/Documents/mutBiasCI/data/TwoTraitSim/mutBiasCI_data_all_simulation_indx_of_collected_data_ml-200-2.dat',indx_of_collected_data,'delimiter',',','precision',16);
