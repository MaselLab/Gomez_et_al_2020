...
def get_graph_data(N,s,v,log_s_lbd1,log_s_lbd2):
    ...
    return [succ_shade,conc_shade,disc_shade,sU_tradeoff_conc_curve1, \
            sU_tradeoff_conc_curve2,sU_tradeoff_succ_curve1,sU_tradeoff_succ_curve2]
...
[succ_sh_vl,conc_sh_vl,disc_sh_vl,c_curve1_vl,c_curve2_vl,s_curve1_vl,s_curve2_vl] = get_graph_data(Nm,s,vl,s_lbd1,s_lbd2)
[succ_sh_vm,conc_sh_vm,disc_sh_vm,c_curve1_vm,c_curve2_vm,s_curve1_vm,s_curve2_vm] = get_graph_data(Nm,s,vm,s_lbd1,s_lbd2)
[succ_sh_vh,conc_sh_vh,disc_sh_vh,c_curve1_vh,c_curve2_vh,s_curve1_vh,s_curve2_vh] = get_graph_data(Nm,s,vh,s_lbd1,s_lbd2)
...
ax1.plot(s_curve1_vl[:,0],s_curve1_vl[:,1],color="mediumblue",linewidth=2,linestyle=":")
ax1.plot(s_curve2_vl[:,0],s_curve2_vl[:,1],color="mediumblue",linewidth=2,linestyle="-",label="Origin-fixation")

ax1.plot(c_curve1_vm[:,0],c_curve1_vm[:,1],color="purple",linewidth=2,linestyle="-",label="Concurrent")
ax1.plot(c_curve2_vm[:,0],c_curve2_vm[:,1],color="purple",linewidth=2,linestyle=":")
ax1.plot(s_curve1_vm[:,0],s_curve1_vm[:,1],color="purple",linewidth=2,linestyle=":")
ax1.plot(s_curve2_vm[:,0],s_curve2_vm[:,1],color="purple",linewidth=2,linestyle="-",label="Origin-fixation")

ax1.plot(c_curve1_vh[:,0],c_curve1_vh[:,1],color="red",linewidth=2,linestyle="-",label="Concurrent")
ax1.plot(c_curve2_vh[:,0],c_curve2_vh[:,1],color="red",linewidth=2,linestyle=":")
...
ax2.fill_between(succ_shade[:,0],succ_shade[:,1],succ_shade[:,2],facecolor="deepskyblue")
ax2.fill_between(conc_shade[:,0],conc_shade[:,1],conc_shade[:,2],facecolor="gold")
ax2.fill_between(disc_shade[:,0],disc_shade[:,1],disc_shade[:,2],facecolor="limegreen")

ax2.plot(sU_tradeoff_conc_curve1[:,0],sU_tradeoff_conc_curve1[:,1],color="mediumblue",linewidth=2,linestyle="-",label="Concurrent")
ax2.plot(sU_tradeoff_conc_curve2[:,0],sU_tradeoff_conc_curve2[:,1],color="mediumblue",linewidth=2,linestyle=":")
ax2.plot(sU_tradeoff_succ_curve1[:,0],sU_tradeoff_succ_curve1[:,1],color="red",linewidth=2,linestyle=":")
ax2.plot(sU_tradeoff_succ_curve2[:,0],sU_tradeoff_succ_curve2[:,1],color="red",linewidth=2,linestyle="-",label="Origin-fixation")
...
fig2.savefig('figures/fig_sUtradeoff_pheno_adaptN1v1.pdf')
