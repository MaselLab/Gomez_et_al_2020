...
# -----------------------------------------------------------------------------
# -----------------------------------------------------------------------------
# process simulation data for updated figure for comparing V of two traits 
...
data_file=open('data/mutBiasCI_data_all_simulation_grand_means_ml-15-1.dat')
grand_means = data_file.read().splitlines()
data_file.close()
data_file=open('data/mutBiasCI_data_all_simulation_parameters_ml-15-0.dat')
parameters = data_file.read().splitlines()
data_file.close()
del data_file
