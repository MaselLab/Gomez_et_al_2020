...
dlmwrite('~/Documents/mutBiasCI/data/FixedsU/mutBiasCI_data_all_simulation_parameters_fixed_sU_OF_ml-01-0.dat',NsU,'delimiter',',','precision',16);
dlmwrite('~/Documents/mutBiasCI/data/FixedsU/mutBiasCI_data_all_simulation_grand_means_fixed_sU_OF_ml-01-1.dat',sim_data,'delimiter',',','precision',16);
dlmwrite('~/Documents/mutBiasCI/data/FixedsU/mutBiasCI_data_all_simulation_indx_of_collected_data_fixed_sU_OF_ml-01-2.dat',indx_of_collected_data,'delimiter',',','precision',16);
...
% name the output files and location to store them
outputfile = '~/Documents/mutBiasCI/data/FixedsU/mutBiasCI_data_fixed_sU_HR_ml-01'; 
...
dlmwrite('~/Documents/mutBiasCI/data/FixedsU/mutBiasCI_data_all_simulation_parameters_fixed_sU_HR_ml-01-0.dat',NsU,'delimiter',',','precision',16);
dlmwrite('~/Documents/mutBiasCI/data/FixedsU/mutBiasCI_data_all_simulation_grand_means_fixed_sU_HR_ml-01-1.dat',sim_data,'delimiter',',','precision',16);
dlmwrite('~/Documents/mutBiasCI/data/FixedsU/mutBiasCI_data_all_simulation_indx_of_collected_data_fixed_sU_HR_ml-01-2.dat',indx_of_collected_data,'delimiter',',','precision',16);