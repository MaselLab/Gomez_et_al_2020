...
pickle_file_name = 'fig_compare_sU_data-02.pickle'    # data for comparison with fixed v
...
cbar.ax.text(2.8,0.6,'Ratio $v_1/v_c$',rotation=270,fontsize=22)    # use this label of comparing v
# *****************************************************************************
...
#plt.text(.2,-2.1,'Trait 2 selection',fontsize=22)
...
fig1.savefig('figures/fig_two_trait_compare_sU_data.pdf',bbox_inches='tight')
